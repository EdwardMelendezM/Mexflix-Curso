	...
	if( empty($ms) ) {
		...
		$template_ms = '
			<div class="item  movieserie-info">
				...
				<iframe width="560" height="760" src="%s" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
				</div>
